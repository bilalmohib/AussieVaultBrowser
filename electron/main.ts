...
ipcMain.on("start-google-signin", () => {
  ...
  const signInUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${
    process.env.GOOGLE_CLIENT_ID || "YOUR_CLIENT_ID"
  }&redirect_uri=aussievault://callback&response_type=code&scope=profile%20email&code_challenge=${codeChallenge}&code_challenge_method=S256`;
